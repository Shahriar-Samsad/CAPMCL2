                ...
                >
                    ...
                    <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            ...
                            <p className="mt-1">Industrial Headquarter
                                Alampur, Gomostapur, Chapai Nawabgonj, Rajshahi.</p>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <a className="text-indigo-500 leading-relaxed">chapaiagro@email.com</a>
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                            <p className="leading-relaxed">+88017000000000</p>
                        </div>
                    </div>
                </div>
                <form action='https://formspree.io/f/mbjeepje' method='POST' className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0"
                >
                    ...
                    <button className=" bg-gradient-to-tr from-orange-500 via-lime-200 to-rose-400 px-8 py-3.5 my-4 rounded-md">Send</button>
