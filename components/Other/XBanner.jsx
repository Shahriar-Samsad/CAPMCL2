...
import bannerImage from "../../Assets/Photos/Yellow-Truck-PNG-Image.png";
const XBanner = () => {
    return (
        <div className='bg-[#101920]'>
            <div id="Banner" className="px-8 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 ">
                ...
                <div className="md:flex  lg:flex justify-between items-center  relative md:px-10 md:gap-x-8 lg:px-14">
                    <div className=" border p-2 max-w-fit mb-6">
                        ...
                        <div className="py-5 px-4 bg-[#192732] rounded-lg">
                            <div className="flex items-center gap-4 rounded-lg">
                                <input type="text" placeholder='Tracking Id' className='border border-slate-500 rounded-lg px-6 py-2.5 bg-transparent text-slate-300' />
